...
public class AccountHolderController {
	...
	@GetMapping("getAccountHolder/{accountNumber}")
	private AccountHolder getAccountHolder(@PathVariable int accountNumber) {
		return accountHolderService.getAccountHolder(accountNumber);
	}
